...
if tkinter.TkVersion in (8.4, 8.5):
    refcountafterdestroy = 7
else:
    refcountafterdestroy = 6

script_name = importlib.util.find_spec(__name__).origin
                ...
                if dont_even_try:
                    ...
                    if option not in ('class', 'container') and not initoption:
                        ...
                        if newvalue != value:
                            ...
                            print('==== new value was:')
                            print(str(newvalue) + ' ' + str(type(newvalue)))
                            print('---- set value was:')
                        ...
                        if option not in ('class', 'container') and not initoption:
                            try:
                                ...
                                (
                                    ...
                                    print('---- setting option returns different value')
                                    print('==== new value was:')
                                    print(repr(newvalue) + ' ' + str(type(newvalue)))
                                    print('---- set value was:')
                                    print(repr(value) + ' ' + str(type(value)))
                                    print('---- FAILED')
                                    print()
                            except:
                                print('==== ' + classCmd.__class__.__name__ + ' widget ' + \
        ...
        if dont_even_try:
            ...
            try:
                ...
                if ref != refcountafterdestroy:
                    ...
                    print('---- refcount ' + str(ref) + ' not zero after destruction')
                    print('---- FAILED')
                    print()
            except:
