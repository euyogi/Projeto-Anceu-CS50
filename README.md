...
Se quiser ver o código e compilar você mesmo, baixe o .zip com todos os arquivos, nele se você quiser compilar com Visual Studio tem uma solução do Visual Studio 2022, além de ser possível compilar com CMake e.g.: ```cmake PATH/new_cpp_app``` depois ```cmake --build PATH/new_cpp_app --config Release```, ambos disponíveis em <a href="new_cpp_app">new_cpp_app</a> e a antiga versão Python em <a href="old_python_app">old_python_app</a>, baixe <a href="https://github.com/euyogi/Projeto-CS50/archive/refs/heads/main.zip">aqui</a>.
